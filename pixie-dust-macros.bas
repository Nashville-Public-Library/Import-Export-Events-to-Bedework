...
'
    ...
    End With
End Sub
Sub Remove_line_breaks()
Attribute Remove_line_breaks.VB_Description = "Removes extra line breaks in the pixie dust Word file"
Attribute Remove_line_breaks.VB_ProcData.VB_Invoke_Func = "Normal.NewMacros.Remove_line_breaks"
'
' Remove_line_breaks Macro
' Removes extra line breaks in the pixie dust Word file
'
    Selection.Find.ClearFormatting
    Selection.Find.Replacement.ClearFormatting
    With Selection.Find
